...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'PageApp_Members'
        db.create_table('page_members_pageapp_members', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('type', self.gf('django.db.models.fields.CharField')(max_length=75)),
        ))
        db.send_create_signal('page_members', ['PageApp_Members'])


    def backwards(self, orm):
        # Deleting model 'PageApp_Members'
        db.delete_table('page_members_pageapp_members')
    ...
    models = {
        ...
        'page_members.pageapp_members': {
            'Meta': {'object_name': 'PageApp_Members'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
