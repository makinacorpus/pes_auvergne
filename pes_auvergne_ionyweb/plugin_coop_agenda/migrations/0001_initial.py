...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Plugin_CoopAgenda'
        db.create_table('plugin_coop_agenda_plugin_coopagenda', (
        ...
        db.send_create_signal('plugin_coop_agenda', ['Plugin_CoopAgenda'])


    def backwards(self, orm):
        # Deleting model 'Plugin_CoopAgenda'
        db.delete_table('plugin_coop_agenda_plugin_coopagenda')
