...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('coop_local_event', 'event_type_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.PROTECT, to=orm['coop_local.EventCategory']))

        # Changing field 'Event.calendar'
        db.alter_column('coop_local_event', 'calendar_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['coop_local.Calendar'], on_delete=models.PROTECT))

        # Changing field 'Event.location'
        db.alter_column('coop_local_event', 'location_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['coop_local.Location'], null=True, on_delete=models.PROTECT))

        # Changing field 'Event.person'
        db.alter_column('coop_local_event', 'person_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['coop_local.Person'], null=True, on_delete=models.PROTECT))

        # Changing field 'Event.organization'
        db.alter_column('coop_local_event', 'organization_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.PROTECT, to=orm['coop_local.Organization']))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Event.event_type'
        db.alter_column('coop_local_event', 'event_type_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['coop_local.EventCategory']))

        # Changing field 'Event.calendar'
        db.alter_column('coop_local_event', 'calendar_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['coop_local.Calendar']))

        # Changing field 'Event.location'
        db.alter_column('coop_local_event', 'location_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['coop_local.Location'], null=True))

        # Changing field 'Event.person'
        db.alter_column('coop_local_event', 'person_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['coop_local.Person'], null=True))

        # Changing field 'Event.organization'
        db.alter_column('coop_local_event', 'organization_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['coop_local.Organization']))
    ...
    models = {
        ...
        'coop_local.area': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'h83mkLaydSrfRed8BNs8LP'", 'max_length': '50', 'null': 'True'})
        },
        'coop_local.calendar': {
            ...
            'uri': ('django.db.models.fields.CharField', [], {'max_length': '250', 'null': 'True', 'blank': 'True'}),
            'uri_mode': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '1'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'d2dB45LguK8WFKTj6Wc2oY'", 'max_length': '50', 'null': 'True'})
        },
        'coop_local.contact': {
            ...
            'uri': ('django.db.models.fields.CharField', [], {'max_length': '250', 'null': 'True', 'blank': 'True'}),
            'uri_mode': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '1'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'rHwxH8obLXLWe2RUEbAjza'", 'max_length': '50', 'null': 'True'})
        },
        ...
        'coop_local.engagement': {
            ...
            'uri': ('django.db.models.fields.CharField', [], {'max_length': '250', 'null': 'True', 'blank': 'True'}),
            'uri_mode': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '1'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'EDZQvBxEPdqwiad9ZNrsEY'", 'max_length': '50', 'null': 'True'})
        },
        'coop_local.event': {
            ...
            'uri': ('django.db.models.fields.CharField', [], {'max_length': '250', 'null': 'True', 'blank': 'True'}),
            'uri_mode': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '1'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'zE2aH55RdHoo76jLRLdyNL'", 'max_length': '50', 'null': 'True'})
        },
        ...
        'coop_local.exchange': {
            ...
            'uri': ('django.db.models.fields.CharField', [], {'max_length': '250', 'null': 'True', 'blank': 'True'}),
            'uri_mode': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '1'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'kHWMeBcdgq57NY8kRvjuQf'", 'max_length': '50', 'null': 'True'})
        },
        ...
        'coop_local.location': {
            ...
            'uri': ('django.db.models.fields.CharField', [], {'max_length': '250', 'null': 'True', 'blank': 'True'}),
            'uri_mode': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '1'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'aQ3C5ft4SeFvDZL665qiy6'", 'max_length': '50', 'null': 'True'}),
        ...
        'coop_local.organization': {
            ...
            'uri': ('django.db.models.fields.CharField', [], {'max_length': '250', 'null': 'True', 'blank': 'True'}),
            'uri_mode': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '1'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'AmPTHc2uwUyaQBzZQK4rCo'", 'max_length': '50', 'null': 'True'}),
        ...
        'coop_local.person': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'Kzv9BwU6jVCpuMgXWLNXGJ'", 'max_length': '50', 'null': 'True'})
        },
        ...
        'coop_local.product': {
            ...
            'uri': ('django.db.models.fields.CharField', [], {'max_length': '250', 'null': 'True', 'blank': 'True'}),
            'uri_mode': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '1'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'ocQgPDBamgfR9c4pmckVcM'", 'max_length': '50', 'null': 'True'})
        },
        'coop_local.relation': {
        ...
        'coop_local.role': {
            ...
            'uri': ('django.db.models.fields.CharField', [], {'max_length': '250', 'null': 'True', 'blank': 'True'}),
            'uri_mode': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '1'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'ddgMzzSxFWzrK5cjAf8pFC'", 'max_length': '50', 'null': 'True'})
        },
        ...
        'coop_local.tag': {
            ...
            'uri': ('django.db.models.fields.CharField', [], {'max_length': '250', 'null': 'True', 'blank': 'True'}),
            'uri_mode': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '1'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'UKtwY5LzaMRWq8j6qh2xd7'", 'max_length': '50', 'null': 'True'})
        },
