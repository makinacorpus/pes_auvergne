...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('coop_local_organization', 'creation',
                      self.gf('django.db.models.fields.DateField')(auto_now_add=True, default=datetime.datetime(2013, 6, 6, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'Organization.modification'
        db.add_column('coop_local_organization', 'modification',
                      self.gf('django.db.models.fields.DateField')(auto_now=True, default=datetime.datetime(2013, 6, 6, 0, 0), blank=True),
                      keep_default=False)
        ...
        db.create_table('coop_local_organization_authors', (
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Organization.transmission_date'
        db.delete_column('coop_local_organization', 'transmission_date')

        # Deleting field 'Organization.validation'
        db.delete_column('coop_local_organization', 'validation')

        # Removing M2M table for field authors on 'Organization'
        db.delete_table('coop_local_organization_authors')
    ...
    models = {
        ...
        'coop_local.area': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'GXzGeSg4emFRCwy6H3ef93'", 'max_length': '50', 'null': 'True'})
        },
        'coop_local.calendar': {
            ...
            'uri': ('django.db.models.fields.CharField', [], {'max_length': '250', 'null': 'True', 'blank': 'True'}),
            'uri_mode': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '1'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'xKJcbxdaJUeCK7dbuVNzvn'", 'max_length': '50', 'null': 'True'})
        },
        ...
        'coop_local.contact': {
            ...
            'uri': ('django.db.models.fields.CharField', [], {'max_length': '250', 'null': 'True', 'blank': 'True'}),
            'uri_mode': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '1'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'CGWb2cBrAmNZ8np9NXdpUN'", 'max_length': '50', 'null': 'True'})
        },
        ...
        'coop_local.engagement': {
            ...
            'uri': ('django.db.models.fields.CharField', [], {'max_length': '250', 'null': 'True', 'blank': 'True'}),
            'uri_mode': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '1'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'Req5of3yRmE7Cn85aXAtzE'", 'max_length': '50', 'null': 'True'})
        },
        'coop_local.event': {
            ...
            'uri': ('django.db.models.fields.CharField', [], {'max_length': '250', 'null': 'True', 'blank': 'True'}),
            'uri_mode': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '1'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'3F2L4ysyNRDpY67LuRD6Hn'", 'max_length': '50', 'null': 'True'})
        },
        ...
        'coop_local.exchange': {
            ...
            'uri': ('django.db.models.fields.CharField', [], {'max_length': '250', 'null': 'True', 'blank': 'True'}),
            'uri_mode': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '1'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'aSnj96qNAVud2GpBkrp6ha'", 'max_length': '50', 'null': 'True'})
        },
        ...
        'coop_local.location': {
            ...
            'uri': ('django.db.models.fields.CharField', [], {'max_length': '250', 'null': 'True', 'blank': 'True'}),
            'uri_mode': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '1'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'QJwHDehyfmLC59TnJmVwMg'", 'max_length': '50', 'null': 'True'}),
        ...
        'coop_local.organization': {
            ...
            'uri': ('django.db.models.fields.CharField', [], {'max_length': '250', 'null': 'True', 'blank': 'True'}),
            'uri_mode': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '1'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'Uu7WgcAWJTxgbZkDM3iYxi'", 'max_length': '50', 'null': 'True'}),
        ...
        'coop_local.person': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'svhEbhwdow2MSk9ZbVLAPi'", 'max_length': '50', 'null': 'True'})
        },
        ...
        'coop_local.product': {
            ...
            'uri': ('django.db.models.fields.CharField', [], {'max_length': '250', 'null': 'True', 'blank': 'True'}),
            'uri_mode': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '1'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'58pxtThWMsp7hMnE36T5d'", 'max_length': '50', 'null': 'True'})
        },
        'coop_local.relation': {
        ...
        'coop_local.role': {
            ...
            'uri': ('django.db.models.fields.CharField', [], {'max_length': '250', 'null': 'True', 'blank': 'True'}),
            'uri_mode': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '1'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'5rDcscaNgAmByp7HAAVr2S'", 'max_length': '50', 'null': 'True'})
        },
        ...
        'coop_local.tag': {
            ...
            'uri': ('django.db.models.fields.CharField', [], {'max_length': '250', 'null': 'True', 'blank': 'True'}),
            'uri_mode': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '1'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'fG7kbK3CTRthCypxkzEvM6'", 'max_length': '50', 'null': 'True'})
        },
