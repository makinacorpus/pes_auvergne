...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'PersonPreferencesContentTypes'
        db.create_table('coop_local_personpreferencescontenttypes', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=100, blank=True)),
        ))
        db.send_create_signal('coop_local', ['PersonPreferencesContentTypes'])

        # Deleting field 'PersonPreferences.type_content'
        db.delete_column('coop_local_personpreferences', 'type_content')

        # Adding M2M table for field type_content on 'PersonPreferences'
        db.create_table('coop_local_personpreferences_type_content', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('personpreferences', models.ForeignKey(orm['coop_local.personpreferences'], null=False)),
            ('personpreferencescontenttypes', models.ForeignKey(orm['coop_local.personpreferencescontenttypes'], null=False))
        ))
        db.create_unique('coop_local_personpreferences_type_content', ['personpreferences_id', 'personpreferencescontenttypes_id'])


    def backwards(self, orm):
        # Deleting model 'PersonPreferencesContentTypes'
        db.delete_table('coop_local_personpreferencescontenttypes')

        # Adding field 'PersonPreferences.type_content'
        db.add_column('coop_local_personpreferences', 'type_content',
                      self.gf('django.db.models.fields.CommaSeparatedIntegerField')(max_length=50, null=True, blank=True),
                      keep_default=False)

        # Removing M2M table for field type_content on 'PersonPreferences'
        db.delete_table('coop_local_personpreferences_type_content')
    ...
    models = {
        ...
        'coop_local.area': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'8GfFEbqNfT5E43pZcHgFck'", 'max_length': '50', 'null': 'True'})
        },
        'coop_local.calendar': {
            ...
            'uri': ('django.db.models.fields.CharField', [], {'max_length': '250', 'null': 'True', 'blank': 'True'}),
            'uri_mode': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '1'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'nLfGzgTe4nmj24rXKouUG8'", 'max_length': '50', 'null': 'True'})
        },
        ...
        'coop_local.contact': {
            ...
            'uri': ('django.db.models.fields.CharField', [], {'max_length': '250', 'null': 'True', 'blank': 'True'}),
            'uri_mode': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '1'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'uew7Gke87A9Am593Jct9cS'", 'max_length': '50', 'null': 'True'})
        },
        ...
        'coop_local.engagement': {
            ...
            'uri': ('django.db.models.fields.CharField', [], {'max_length': '250', 'null': 'True', 'blank': 'True'}),
            'uri_mode': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '1'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'zL7T5GUgoJXUDdA2KRRacX'", 'max_length': '50', 'null': 'True'})
        },
        ...
        'coop_local.event': {
            ...
            'uri': ('django.db.models.fields.CharField', [], {'max_length': '250', 'null': 'True', 'blank': 'True'}),
            'uri_mode': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '1'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'X42MWMugph6A3cDoM3CMPN'", 'max_length': '50', 'null': 'True'}),
        ...
        'coop_local.exchange': {
            ...
            'uri': ('django.db.models.fields.CharField', [], {'max_length': '250', 'null': 'True', 'blank': 'True'}),
            'uri_mode': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '1'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'L8HDWyv98J5CzswBhKo6nY'", 'max_length': '50', 'null': 'True'})
        },
        ...
        'coop_local.location': {
            ...
            'uri': ('django.db.models.fields.CharField', [], {'max_length': '250', 'null': 'True', 'blank': 'True'}),
            'uri_mode': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '1'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'8SUugtNRdeGssGbFTF3AFg'", 'max_length': '50', 'null': 'True'}),
        ...
        'coop_local.organization': {
            ...
            'uri': ('django.db.models.fields.CharField', [], {'max_length': '250', 'null': 'True', 'blank': 'True'}),
            'uri_mode': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '1'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'VK7G3m6afaUVRhqBTVSnF3'", 'max_length': '50', 'null': 'True'}),
        ...
        'coop_local.person': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'mPMVFaXtu9pCQJ7MGESs8A'", 'max_length': '50', 'null': 'True'})
        },
        ...
        'coop_local.product': {
            ...
            'uri': ('django.db.models.fields.CharField', [], {'max_length': '250', 'null': 'True', 'blank': 'True'}),
            'uri_mode': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '1'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'5BMjDJJH37tG7gufpdpiFA'", 'max_length': '50', 'null': 'True'})
        },
        ...
        'coop_local.role': {
            ...
            'uri': ('django.db.models.fields.CharField', [], {'max_length': '250', 'null': 'True', 'blank': 'True'}),
            'uri_mode': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '1'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'pj7gocG7fvPVmq4LttvMb6'", 'max_length': '50', 'null': 'True'})
        },
        ...
        'coop_local.tag': {
            ...
            'uri': ('django.db.models.fields.CharField', [], {'max_length': '250', 'null': 'True', 'blank': 'True'}),
            'uri_mode': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '1'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'kZd8HJGmqY9iVUGCDf3hLB'", 'max_length': '50', 'null': 'True'})
        },
