...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'PersonPreferences'
        db.create_table('coop_local_personpreferences', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('locations_buffer', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('type_content', self.gf('django.db.models.fields.IntegerField')()),
            ('notification', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal('coop_local', ['PersonPreferences'])

        # Adding M2M table for field activities on 'PersonPreferences'
        db.create_table('coop_local_personpreferences_activities', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('personpreferences', models.ForeignKey(orm['coop_local.personpreferences'], null=False)),
            ('activitynomenclature', models.ForeignKey(orm['coop_local.activitynomenclature'], null=False))
        ))
        db.create_unique('coop_local_personpreferences_activities', ['personpreferences_id', 'activitynomenclature_id'])

        # Adding M2M table for field transverse_themes on 'PersonPreferences'
        db.create_table('coop_local_personpreferences_transverse_themes', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('personpreferences', models.ForeignKey(orm['coop_local.personpreferences'], null=False)),
            ('transversetheme', models.ForeignKey(orm['coop_local.transversetheme'], null=False))
        ))
        db.create_unique('coop_local_personpreferences_transverse_themes', ['personpreferences_id', 'transversetheme_id'])

        # Adding M2M table for field locations on 'PersonPreferences'
        db.create_table('coop_local_personpreferences_locations', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('personpreferences', models.ForeignKey(orm['coop_local.personpreferences'], null=False)),
            ('area', models.ForeignKey(orm['coop_local.area'], null=False))
        ))
        db.create_unique('coop_local_personpreferences_locations', ['personpreferences_id', 'area_id'])

        # Adding M2M table for field organizations on 'PersonPreferences'
        db.create_table('coop_local_personpreferences_organizations', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('personpreferences', models.ForeignKey(orm['coop_local.personpreferences'], null=False)),
            ('organization', models.ForeignKey(orm['coop_local.organization'], null=False))
        ))
        db.create_unique('coop_local_personpreferences_organizations', ['personpreferences_id', 'organization_id'])

        # Adding field 'Person.prefs'
        db.add_column('coop_local_person', 'prefs',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['coop_local.PersonPreferences'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'PersonPreferences'
        db.delete_table('coop_local_personpreferences')

        # Removing M2M table for field activities on 'PersonPreferences'
        db.delete_table('coop_local_personpreferences_activities')

        # Removing M2M table for field transverse_themes on 'PersonPreferences'
        db.delete_table('coop_local_personpreferences_transverse_themes')

        # Removing M2M table for field locations on 'PersonPreferences'
        db.delete_table('coop_local_personpreferences_locations')

        # Removing M2M table for field organizations on 'PersonPreferences'
        db.delete_table('coop_local_personpreferences_organizations')

        # Deleting field 'Person.prefs'
        db.delete_column('coop_local_person', 'prefs_id')
    ...
    models = {
        ...
        'coop_local.area': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'KwL42kAqHNg3tFrfxgZmoV'", 'max_length': '50', 'null': 'True'})
        },
        'coop_local.calendar': {
            ...
            'uri': ('django.db.models.fields.CharField', [], {'max_length': '250', 'null': 'True', 'blank': 'True'}),
            'uri_mode': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '1'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'BgCTRt7oV8yhaMxD5asnLX'", 'max_length': '50', 'null': 'True'})
        },
        ...
        'coop_local.contact': {
            ...
            'uri': ('django.db.models.fields.CharField', [], {'max_length': '250', 'null': 'True', 'blank': 'True'}),
            'uri_mode': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '1'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'c4eTP3LWXoQ2jgrMKm4hyJ'", 'max_length': '50', 'null': 'True'})
        },
        ...
        'coop_local.engagement': {
            ...
            'uri': ('django.db.models.fields.CharField', [], {'max_length': '250', 'null': 'True', 'blank': 'True'}),
            'uri_mode': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '1'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'dxMsQn8Y7vDuZK9eR4chg9'", 'max_length': '50', 'null': 'True'})
        },
        ...
        'coop_local.evaluationanswer': {
            'Meta': {'object_name': 'EvaluationAnswer'},
            'answer': ('django.db.models.fields.SmallIntegerField', [], {'null': 'True', 'blank': 'True'}),
            'evaluation': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['coop_local.Evaluation']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'question': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['coop_local.EvaluationQuestion']"})
        },
        'coop_local.evaluationquestion': {
            'Meta': {'object_name': 'EvaluationQuestion'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'theme': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['coop_local.EvaluationQuestionTheme']", 'null': 'True', 'blank': 'True'})
        },
        'coop_local.evaluationquestiontheme': {
            'Meta': {'ordering': "['label']", 'object_name': 'EvaluationQuestionTheme'},
            'cssclass': ('django.db.models.fields.CharField', [], {'max_length': '50', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'label': ('django.db.models.fields.CharField', [], {'max_length': '1024', 'blank': 'True'})
        },
        'coop_local.event': {
            ...
            'uri': ('django.db.models.fields.CharField', [], {'max_length': '250', 'null': 'True', 'blank': 'True'}),
            'uri_mode': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '1'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'8mjUk9tRD48XRfPEqgKujZ'", 'max_length': '50', 'null': 'True'}),
        ...
        'coop_local.exchange': {
            ...
            'uri': ('django.db.models.fields.CharField', [], {'max_length': '250', 'null': 'True', 'blank': 'True'}),
            'uri_mode': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '1'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'TGvZFp3zHC3bZNY2xzkvkG'", 'max_length': '50', 'null': 'True'})
        },
        ...
        'coop_local.location': {
            ...
            'uri': ('django.db.models.fields.CharField', [], {'max_length': '250', 'null': 'True', 'blank': 'True'}),
            'uri_mode': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '1'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'7iFPHi7orHUXt4GfGaGmUK'", 'max_length': '50', 'null': 'True'}),
        ...
        'coop_local.organization': {
            ...
            'uri': ('django.db.models.fields.CharField', [], {'max_length': '250', 'null': 'True', 'blank': 'True'}),
            'uri_mode': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '1'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'VfCfEurUr3Q87G4QVi7YJ5'", 'max_length': '50', 'null': 'True'}),
        ...
        'coop_local.person': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'eGuZpWmV52PUbKTMEj5kUh'", 'max_length': '50', 'null': 'True'})
        },
        ...
        'coop_local.personpreferences': {
            ...
            'transverse_themes': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': "orm['coop_local.TransverseTheme']", 'null': 'True', 'blank': 'True'}),
            'type_content': ('django.db.models.fields.IntegerField', [], {})
        },
        'coop_local.product': {
            ...
            'uri': ('django.db.models.fields.CharField', [], {'max_length': '250', 'null': 'True', 'blank': 'True'}),
            'uri_mode': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '1'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'hfoSZrC94XMFhLhFaMoBo9'", 'max_length': '50', 'null': 'True'})
        },
        ...
        'coop_local.role': {
            ...
            'uri': ('django.db.models.fields.CharField', [], {'max_length': '250', 'null': 'True', 'blank': 'True'}),
            'uri_mode': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '1'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'C4awcWRfFmh3XGWHBWCLpW'", 'max_length': '50', 'null': 'True'})
        },
        ...
        'coop_local.tag': {
            ...
            'uri': ('django.db.models.fields.CharField', [], {'max_length': '250', 'null': 'True', 'blank': 'True'}),
            'uri_mode': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '1'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'KhKojMuh68upLRT5ik99n8'", 'max_length': '50', 'null': 'True'})
        },
