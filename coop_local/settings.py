# -*- coding:utf-8 -*-
# Django settings for allianceprovence project.
...
SECRET_KEY = '329o$v#ht7q@xu35-de=d%4%%93o(qn+40ym9k=ng-_*x807x4'

import os.path
PROJECT_PATH = os.path.dirname(os.path.dirname(os.path.abspath(__file__)))
#PROJECT_NAME = PROJECT_PATH.split('/')[-1]
PROJECT_NAME = 'allianceprovence'  # which one is safer ?
